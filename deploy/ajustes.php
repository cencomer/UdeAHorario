...
<div class="card-group">
<div class="sr"><span>Compartir app</span><button class="btn btn-green" onclick="if(navigator.share)navigator.share({title:'Horario UdeA',url:'https://regudea.inteligencia.com.co'});else{navigator.clipboard.writeText('https://regudea.inteligencia.com.co');this.textContent='¡Copiado!'}">Compartir</button></div>
</div>
